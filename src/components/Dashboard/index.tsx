    ...
    <div className="Dashboard">
      ...
      <div className="picture">
        <a href="https://docs.google.com">
          <div className="icon">
            ...
            <img src='https://images.idgesg.net/images/article/2019/05/google-docs-logo-100796136-large.jpg' alt="Google Docs" width="131" />
          </div>
        </a>
      ...
      <div className="picture">
        <a href="https://drive.google.com/drive/my-drive">
          <div className="icon">
            <img src='https://sites.google.com/a/bhuhsd.net/jessica-rapetti-u-s-government-economics-eportfolio-bhhs2014/_/rsrc/1421979558598/s6-unit-2-the-goals-and-the-origins-of-our-government-1/home/google%20drive.png?height=200&width=200' alt="Google Drive" width="100" />
          </div>
        </a>
